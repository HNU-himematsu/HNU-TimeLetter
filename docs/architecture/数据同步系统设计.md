...
- [InteractiveMap.tsx](src/components/desktop/InteractiveMap.tsx)
- [QuillSearch.tsx](src/components/desktop/QuillSearch.tsx)
- [MobileExperience.tsx](src/components/mobile/MobileExperience.tsx)
- [StaticMapModal.tsx](src/components/mobile/StaticMapModal.tsx)
- [StoryFeed.tsx](src/components/mobile/StoryFeed.tsx)
- [creation/page.tsx](src/app/creation/page.tsx)

服务端也有静态 import 配置：

- [sync.ts](src/lib/sync-service.ts)
